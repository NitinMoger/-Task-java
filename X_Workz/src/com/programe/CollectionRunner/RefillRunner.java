...
public class RefillRunner {
    public static void main(String[] args) {
        RefillDTO speakerDTO = new RefillDTO(3, 1000, "BallPoint Refill", "Asa beauty");
        RefillDTO speakerDTO1 = new RefillDTO(4, 1500, "Rollerball Refill", "Conklin pen");
        RefillDTO speakerDTO2 = new RefillDTO(2, 3000, "Pencil lead", "fenty Skin");
        RefillDTO speakerDTO3 = new RefillDTO(5, 2500, "Eraser refil", "hermes");
        RefillDTO speakerDTO4 = new RefillDTO(1, 2000, "Gel Refill", "Ouai");
        ...
        Comparator<RefillDTO> comparator = new RefillComparatorQuantity();
